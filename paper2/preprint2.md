> **INTERNAL DRAFT — NOT FOR SUBMISSION OR DISTRIBUTION without the
> founder's explicit approval.**
>
> Version 2.3, 2026-09-15, by session `luviner-9f` against board row
> PAPER-2; first drafted 2026-09-12.
> Every number below is on the board and traces to a registration commit
> that precedes it; the index is §9. The outline this replaces is
> `LEARNING-REDISTRIBUTES.md`, which is kept as the pre-registration ledger.
> Claims are bounded by `FRAMING-2026-09-11.md` and were checked against it
> line by line before this file was committed.
...
companion preprint's code and data (Groppi & Ferrari, 2026; reference 17;
Zenodo concept DOI 10.5281/zenodo.22287792, version v1.0.1
10.5281/zenodo.22287793). Code is MIT-licensed; text, figures and data are
CC BY 4.0.

**[A Zenodo release DOI for this study's deposit is to be inserted here before
submission.]**
...
a figure from the run outputs and compares it against this manuscript, exiting
