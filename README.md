...
DOI (concept, always the latest release): [10.5281/zenodo.22287792](https://doi.org/10.5281/zenodo.22287792). Releases: v1.0.1 [10.5281/zenodo.22287793](https://doi.org/10.5281/zenodo.22287793) archives the state at the first preprint; v1.1.1 `10.5281/zenodo.22768648` archives it at the second.
...
supplementary note and registration record in `paper2/`, archived as release
v1.1.1 (`10.5281/zenodo.22768648`). Its bioRxiv DOI (`BIORXIV_DOI`) is added here once
